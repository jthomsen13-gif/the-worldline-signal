  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-3xl px-6 pb-24 pt-28 text-center">
        ...
        <p className="mt-3 text-lg italic text-foreground/70 md:text-xl">
        ...
        <div className="mt-7 inline-flex items-center rounded-full border border-border/60 bg-secondary/80 px-4 py-1 font-mono text-[10px] uppercase tracking-[0.25em] text-muted-foreground">
